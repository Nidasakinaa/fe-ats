...
<tr class="h-18 border-b border-coolGray-100">
    ...
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">#JENIS KELAMIN#</th>
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-500 text-left">#AGAMA#</th>
    ...
    <th class="whitespace-nowrap px-4 bg-white text-left">
      <div class="w-auto p-2">
        <p class="text-xs font-semibold text-coolGray-800">#JALAN#</p>
        <p class="text-xs font-medium text-coolGray-500">#KODE POS#</p>
      </div>
    </th>
